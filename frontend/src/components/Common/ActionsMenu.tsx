...
import type { ItemCategoryPublic, ItemPublic, ItemUnitPublic, SupplierPublic, UserPublic } from "../../client"
...
interface ActionsMenuProps {
  type: string
  value: ItemCategoryPublic | ItemPublic | UserPublic | SupplierPublic | ItemUnitPublic
  disabled?: boolean
}
