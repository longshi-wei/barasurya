...
interface EditCustomerTypeProps {
  customer_type: CustomerTypePublic
  isOpen: boolean
  onClose: () => void
}

const EditCustomerType = ({ customer_type, isOpen, onClose }: EditCustomerTypeProps) => {
  ...
  const mutation = useMutation({
    ...
    onSettled: () => {
      queryClient.invalidateQueries({ queryKey: ["customer_types"] })
    },
  })

  const onSubmit: SubmitHandler<CustomerTypeUpdate> = async (data) => {
